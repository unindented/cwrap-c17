#ifndef CWRAP_UNICODE_WIDTH_DATA_H
#define CWRAP_UNICODE_WIDTH_DATA_H

#include <stdint.h>

/** Inclusive Unicode code-point interval. */
struct CodepointRange {
  /** First code point in the interval. */
  uint32_t first;

  /** Last code point in the interval. */
  uint32_t last;
};

/** Unicode 16.0 combining marks and format characters that occupy no column. */
static const struct CodepointRange unicode_zero_width_ranges[] = {
...
/** Unicode 16.0 code points whose East Asian Width property is `W` or `F`. */
static const struct CodepointRange unicode_wide_ranges[] = {
