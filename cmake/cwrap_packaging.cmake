...
install(TARGETS cwrap RUNTIME COMPONENT cwrap_runtime)
install(
  FILES "${PROJECT_SOURCE_DIR}/README.md"
        "${PROJECT_SOURCE_DIR}/LICENSE.txt"
        "${PROJECT_SOURCE_DIR}/THIRD_PARTY_NOTICES.md"
  DESTINATION "${CMAKE_INSTALL_DOCDIR}"
  COMPONENT cwrap_runtime
)

string(TOLOWER "${CMAKE_SYSTEM_NAME}" cwrap_target_system)
set(CWRAP_RELEASE_TARGET
    "${CMAKE_SYSTEM_PROCESSOR}-${cwrap_target_system}"
    CACHE STRING "Platform label in the release archive name"
)

set(CPACK_PACKAGE_NAME "cwrap")
...
set(CPACK_PACKAGE_FILE_NAME "${CPACK_PACKAGE_NAME}-${PROJECT_VERSION}-${CWRAP_RELEASE_TARGET}")
