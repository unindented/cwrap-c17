...
foreach(required IN ITEMS CWRAP_GRAPHVIZ_SVG_INPUT CWRAP_GRAPHVIZ_SVG_OUTPUT)
  if(NOT DEFINED ${required})
    message(FATAL_ERROR "${required} must be defined")
  endif()
endforeach()

get_filename_component(input_file "${CWRAP_GRAPHVIZ_SVG_INPUT}" ABSOLUTE)
get_filename_component(output_file "${CWRAP_GRAPHVIZ_SVG_OUTPUT}" ABSOLUTE)
